...
Jobboard gives website visitors an overview of currently open job positions -
...
..  figure:: ../Images/jobboardExample.png
    :width: 500px
    :alt: Jobboard frontend output showing a searchable job list
    :zoom: lightbox

    Frontend output of Jobboard: a searchable, sortable list of open job
    positions.
